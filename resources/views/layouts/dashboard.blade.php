...
<html lang="en">
 ...
 @yield('content')
    ...
    <!-- jVectorMap -->
    <script src="production/js/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="production/js/maps/jquery-jvectormap-us-aea-en.js"></script>
    <script src="production/js/maps/gdp-data.js"></script>
    <script>
      $(document).ready(function(){
